...
public class StartView {
    ...
    public Scene build() {
        Button startBtn = ComponentFactory.buildNavButton("START GAME");
        startBtn.setOnAction(e -> SceneManager.getInstance().switchScene(new LobbyView().build()));

        VBox center = new VBox(60, ComponentFactory.buildMainTitle(), startBtn);
